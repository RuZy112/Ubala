      ...
      <Grid className={classes.mt1} container spacing={1}>
        ...
        <Grid item md={9}>
          <Grid container justifyContent="space-between" alignItems="center">
            <Grid item>
              {products.length === 0 ? 'No' : countProducts} Tulemust
              {query !== 'all' && query !== '' && ' : ' + query}
              {category !== 'all' && ' : ' + category}
              {brand !== 'all' && ' : ' + brand}
              {price !== 'all' && ' : Price ' + price}
              {rating !== 'all' && ' : Rating ' + rating + ' & parem'}
              {(query !== 'all' && query !== '') ||
              category !== 'all' ||
              brand !== 'all' ||
              rating !== 'all' ||
            ...
            <Grid item>
              ...
              <Select value={sort} onChange={sortHandler}>
                <MenuItem value="featured">Esile tõstetud</MenuItem>
                <MenuItem value="lowest">Odavamad enne</MenuItem>
                <MenuItem value="highest">Kallimad enne</MenuItem>
                <MenuItem value="toprated">Enim hinnatud</MenuItem>
                <MenuItem value="newest">Uuemad enne</MenuItem>
              </Select>
            </Grid>
          </Grid>
